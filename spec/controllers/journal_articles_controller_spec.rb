...
RSpec.describe JournalArticlesController, type: :controller do
  let(:valid_attributes) do
    { 'author_first_name' => %w[Test Person], 'author_last_name' => %w[Case 2], 'college_ids' => ['', '1', '4'], 'uc_department' => 'Test', 'work_title' => 'Test', 'other_title' => 'Test', 'volume' => 'Test', 'issue' => 'Test', 'page_numbers' => 'Test', 'publication_date' => 'Test', 'url' => 'Test', 'doi' => 'Test', 'submitter_id' => submitter.id }
  end

  let(:invalid_attributes) do
    { 'author_first_name' => ['Bad'], 'author_last_name' => [''], 'college_ids' => [''], 'uc_department' => '', 'work_title' => '', 'other_title' => '', 'volume' => '', 'issue' => '', 'page_numbers' => '', 'publication_date' => '', 'url' => '', 'doi' => '', 'submitter_id' => submitter.id }
  end
  ...
  describe 'PUT #update' do
    ...
    context 'with valid params' do
      ...
      it 'updates the requested journal_article' do
        ...
        expect(journal_article.author_first_name).to eql %w[Test Person] # verify unchanged
      ...
      it 'redirects to the journal_article' do
        put :update, params: { id: journal_article.id, journal_article: valid_attributes }
