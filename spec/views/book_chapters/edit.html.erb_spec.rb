...
RSpec.describe 'book_chapters/edit', type: :view do
  before(:each) do
    @book_chapter = FactoryBot.create(:book_chapter)
  end

  it 'renders the edit book_chapter form' do
    render

    assert_select 'form[action=?][method=?]', book_chapter_path(@book_chapter), 'post' do
